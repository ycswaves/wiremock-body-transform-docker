...
CMD java -jar /wiremock-body-transformer-1.1.1.jar:/wiremock-standalone-$WIREMOCK_VERSION.jar $WIREMOCK_ARGS --extensions com.opentable.extension.BodyTransformer
